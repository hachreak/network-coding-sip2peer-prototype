...
//	private InputStream is;
	...
	public void testOriginalMediaResourcePiece() {
		try {
			int index = 3;
			fragmentSize = 5;
			GFMatrix o = MediaResource.loadTransposedPiece(new FileInputStream(file), (int) file.length(), fragmentSize, index, galoisField);
//			OriginalMediaResourcePiece o = new MediaResource(file, fragmentSize, index, galoisField);
